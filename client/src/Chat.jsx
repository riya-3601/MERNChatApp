        ...
        <div className="flex h-screen">
            <div className="bg-white w-1/3 flex flex-col ">
                ...
                <div className="p-2 text-center flex items-center">
                    <span className="mr-2 text-sm test-gray-600 flex items-center">
            ...
            <div className="flex flex-col bg-blue-50 w-2/3 p-2">
                ...
                {!!selectedUserId &&(
                    ...
                    <label type="button" className="bg-blue-200 p-2 cursor-pointer text-gray-600 rounded-sm border border-blue-200">
